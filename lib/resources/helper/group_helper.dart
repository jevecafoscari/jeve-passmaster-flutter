...
class GroupHelper {
  ...
  static Future<void> editGroup(GroupModel group) => References.groupsCollection.doc(group.id).update(group.toJson());

  static Future<void> deleteGroup(GroupModel group) => References.groupsCollection.doc(group.id).delete();
}
